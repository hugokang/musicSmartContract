      ...
      <div class="row">
          ...
          <div class="card mt-3 mb-3">
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                <template v-for="tune in myTunes" v-if="account">
        ...
        <div class="col col-12 col-md-6">
          <div class="card mt-3 mb-3">
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                <template v-for="tune in myFavorites" v-if="account">
  ...
  methods: {
    getArtistTunes () {
      ...
      this.$parent.ctContract.deployed()
        .then(instance => {
          return instance.getArtistTunes(this.account)
        })
        .then(res => {
          // console.info('artist tunes => ', res)
          res.reverse()
          vm.myTunes = JSON.parse(JSON.stringify(res))
        })
        .catch(err => {
          console.error(err)
        })
